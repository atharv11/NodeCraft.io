    ...
    <div className="fixed p-4 top-0 left-0 z-40 w-50 md:w-64 h-full md:h-screen">
      ...
      <aside className=" bg-[linear-gradient(to_bottom,#E0F2FE,transparent)] border-r-2  border-white  flex flex-col gap-2 h-full rounded-2xl shadow-2xl  overflow-hidden">
        ...
        >
          ...
          <div className="flex mb-7 items-center justify-center gap-2 self-start rounded-lg   bg-transparent p-1.5 text-gray-900 transition-colors hover:bg-gray-500 hover:text-white cursor-pointer w-fit px-4">
  <FaArrowLeft size={14} /> 
