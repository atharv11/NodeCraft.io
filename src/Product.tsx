...
const Process = ({ data, id }: NodeProps<ProcessNode>) => {
  ...
  // --- FIX 1: Move functions OUT of onChange so they can be called ---
  ...
  return (
    <div className="w-full h-full ">
      <div className="ProcessNode rounded-3xl bg-[#242424] text-white shadow-2xl">
        ...
        <div className="bg-[#353535] rounded-3xl p-3">
          <input
            ...
            onChange={onChange}
            className="nodrag text-[1.5vw] bg-transparent outline-none text-white w-full"
            value={data.ItemName || ""} // Changed to value for live sync
          />
        </div>
      </div>
